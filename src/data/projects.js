export const PROJECTS = [
  ...
  },
  {
    ...
    tagline: "Intelligent Workflow Triage & Dispatch",
    category: "Business Workflow Automation",
    tier: "production",
    status: "active",
    summary:
      "Autonomous operations agent that monitors webhooks, categorizes inbound operational incidents, updates CRMs, and notifies engineering teams with under 60-second latency.",
    metrics: [
      { label: "SYSTEM ACCURACY", value: "92.5%", trend: "positive" },
      { label: "RESPONSE LATENCY", value: "<60s", trend: "positive" },
      { label: "TRIAGE DEFLECTION", value: "75%+", trend: "positive" },
    ],
    techStack: ["n8n", "Node.js", "Webhook APIs", "Slack API", "HubSpot", "Redis"],
    architectureFlow: [
      {
        step: "01",
        name: "Webhook Ingestion",
        detail: "Real-time payload ingestion from customer touchpoints and webhooks.",
      },
      {
        step: "02",
        name: "Sentiment & Urgency",
        detail: "LLM scoring of operational urgency, customer sentiment, and intent.",
      },
      {
        step: "03",
        name: "CRM & Slack Sync",
        detail: "Bi-directional database sync and Slack incident creation.",
      },
      {
        step: "04",
        name: "FinOps Token Track",
        detail: "Real-time cost tracking per transaction and API call.",
      },
    ],
